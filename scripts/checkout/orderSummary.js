...
export function renderOrderSummary() {
  ...
  // }
    ...
    cartSummaryHTML += `
        <div class="cart-item-container js-cart-item-container js-cart-item-container-${cartItem.productId.id}">
          ...
          <div class="cart-item-details-grid">
            ...
            <div class="cart-item-details">
              ...
              <div class="js-product-quantity-${cartItem.productId.id} product-quantity">
                <span>
                ...
                <span class="delete-quantity-link link-primary js-delete-link js-delete-link-${cartItem.productId.id}" data-product-id="${cartItem.productId.id}">
                  Delete
                </span>
              </div>
            </div>
      ...
      document.querySelector('.js-payment-summary').innerHTML = cartSummaryHTML;
  ...
  deliveryOptions.forEach((deliveryOption) => {
    ...
    HTML += `
        <div class="js-delivery-option delivery-option"
          ...
          <input type="radio"
            ${isChecked?'checked':''}
            class="js-delivery-option-input-${deliveryOption.id}js-delivery-option-input delivery-option-input"
